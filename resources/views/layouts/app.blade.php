...
<body class="bg-white text-gray-800 font-sans">
    ...
    <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3"
        ...
        <button @click="open = !open"
                class="w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 rounded-2xl flex items-center justify-center shadow-md shadow-blue-500/15 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-200 hover:scale-105 relative">
