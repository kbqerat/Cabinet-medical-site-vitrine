...
<div class="max-w-2xl mx-auto space-y-5">
    ...
    <div class="bg-white rounded-2xl border border-red-100 shadow-sm overflow-hidden"
         x-data="{
             ...
             passInput: '',
             loading: false,
             get canDelete() { return this.emailInput === '{{ addslashes(auth()->user()->email ?? '') }}' && this.passInput.length >= 1; }
         }">
        ...
        <div x-show="showModal" x-cloak
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden"
                ...
                <div class="px-6 py-5">
                    ...
                    <p class="text-xs font-mono font-bold text-gray-800 bg-gray-100 rounded-lg px-3 py-2 mb-4 select-all">{{ auth()->user()->email }}</p>
