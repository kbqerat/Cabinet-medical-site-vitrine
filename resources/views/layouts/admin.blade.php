...
<head>
    ...
    <title>@yield('title', 'Admin — MediAssist')</title>
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <a href="/" class="flex items-center gap-3 px-5 py-[18px] border-b border-white/10 hover:bg-white/5 transition-colors">
                ...
                <div>
                    ...
                    <p class="text-[9px] text-blue-300/60 font-semibold uppercase tracking-widest">Administration</p>
                </div>
            </a>
            ...
            <nav class="flex-1 px-3 pb-4 space-y-0.5 overflow-y-auto">
                @php
                $navItems = [
                    ['href' => '/admin/dashboard',  'icon' => 'M4 5a1 1 0 011-1h4a1 1 0 011 1v5a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm10 0a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1v-2zm10 0a1 1 0 011-1h4a1 1 0 011 1v5a1 1 0 01-1 1h-4a1 1 0 01-1-1v-5z', 'label' => 'Vue d\'ensemble'],
                    ['href' => '/admin/medecins',    'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z', 'label' => 'Médecins'],
                    ['href' => '/admin/plans',       'icon' => 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z', 'label' => 'Plans & Abonnements'],
                    ['href' => '/admin/messages',    'icon' => 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z', 'label' => 'Messages'],
                    ['href' => '/admin/profil',      'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', 'label' => 'Mon profil'],
                ...
                <a href="{{ $item['href'] }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-medium transition-all duration-150
                          {{ $active
                              ...
                              : 'text-blue-200/60 hover:bg-white/[0.07] hover:text-blue-100' }}">
                    @if($active)
            ...
            <div class="px-3 py-3 border-t border-white/10 bg-black/10 relative"
                ...
                <button @click="open = !open" type="button"
                    ...
                    <div class="w-7 h-7 rounded-lg flex items-center justify-center text-[11px] font-bold text-white flex-shrink-0"
                        ...
                        {{ strtoupper(substr(session('firebase_email', 'A'), 0, 1)) }}
                    </div>
                ...
                <div x-show="open" x-cloak
                    ...
                    @php
                    $userMenu = [
                        ['href' => '/admin/dashboard',  'label' => 'Vue d\'ensemble', 'icon' => 'M4 5a1 1 0 011-1h4a1 1 0 011 1v5a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm10 0a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1v-2zm10 0a1 1 0 011-1h4a1 1 0 011 1v5a1 1 0 01-1 1h-4a1 1 0 01-1-1v-5z'],
                        ['href' => '/admin/medecins',   'label' => 'Médecins',         'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z'],
                        ...
                        ['href' => '/admin/profil',     'label' => 'Mon profil',        'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z'],
                    ...
                    <div class="px-4 py-3 border-b border-gray-100">
                        <p class="text-xs font-semibold text-gray-800 truncate">Administrateur</p>
