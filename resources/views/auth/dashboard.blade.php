        ...
        <div class="px-3 py-3 border-t border-white/10 bg-black/10 relative"
            ...
            <button @click="open = !open" type="button"
                ...
                <div class="w-7 h-7 rounded-lg flex items-center justify-center text-[11px] font-bold text-white flex-shrink-0"
                    ...
                    {{ strtoupper(substr(auth()->user()->email ?? 'D', 0, 1)) }}
                </div>
                <div class="min-w-0 flex-1 text-left">
                    <p class="text-[11px] font-semibold text-white truncate leading-tight">Dr. {{ trim(auth()->user()->first_name . ' ' . auth()->user()->last_name) ?: 'Médecin' }}</p>
            ...
            <div x-show="open" x-cloak
                ...
                <div class="px-4 py-3 border-b border-gray-100">
                    <p class="text-xs font-semibold text-gray-800 truncate">Dr. {{ trim(auth()->user()->first_name . ' ' . auth()->user()->last_name) ?: 'Médecin' }}</p>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-xs font-medium text-gray-700 truncate max-w-[160px]">{{ auth()->user()->email }}</span>
                            </div>
                            <div class="flex items-center justify-between">
